export default {
  ...
  'lang.simplified-chinese': 'đ¨đł çŽä˝ä¸­ć',
  'lang.traditional-chinese': 'đ­đ° çšä˝ä¸­ć',
  'lang.english': 'đŹđ§ English',
  'lang.portuguese': 'đľđš Portuguese',
  ...
  'app.login.message-invalid-credentials': 'Invalid username or passwordďźadmin/888888ďź',
  ...
  'app.register-result.msg': 'Accountďźregistered at {email}',
  ...
  'app.settings.basic.updatepwd': 'Update Password',
  'app.settings.basic.oldpwd': 'old password',
  'app.settings.basic.oldpwd-message': 'please enter old password',
  'app.settings.basic.newpwd': 'new password',
  'app.settings.basic.newpwd-message': 'please enter new password',
  'app.settings.basic.newpwdagain': 'new password again',
  'app.settings.basic.newpwdagain-message': 'please enter new password again',
  'app.settings.security.strong': 'Strong',
  'app.settings.security.medium': 'Medium',
  'app.settings.security.weak': 'Weak',
  'app.settings.security.password': 'Account Password',
  'app.settings.security.password-description': 'Current password strengthďź',
  'app.settings.security.phone': 'Security Phone',
  'app.settings.security.phone-description': 'Bound phoneďź',
  'app.settings.security.question': 'Security Question',
  'app.settings.security.question-description':
    'The security question is not set, and the security policy can effectively protect the account security',
  'app.settings.security.email': 'Backup Email',
  'app.settings.security.email-description': 'Bound Emailďź',
