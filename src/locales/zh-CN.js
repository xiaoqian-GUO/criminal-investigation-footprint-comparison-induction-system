export default {
  ...
  'menu.infoconclude': '串并案件',
  'menu.infoconclude.conclude': '案件归纳对比',
  'menu.infoconclude.concludecases': '串并案添加',
  'menu.infoconclude.caselist': '案件管理',
  'menu.infoconclude.mergecaselist': '串并案管理',
  'menu.infoquery': '足迹信息管理',
  'menu.infoquery.basicInfo': '足迹信息查询',
  'menu.infoquery.basicResult': '足迹信息修改',
  'menu.infocollection': '足迹信息采集',
  'menu.infocollection.collect': '足迹信息采集',
  'menu.infocollection.collectCase': '案件信息采集',
  'menu.infocollection.success': '信息采集成功',
  'menu.infocollection.caselist': '案件管理',
  'menu.result': '结果页',
  ...
  'app.settings.basic.username': '用户名',
  'app.settings.basic.username-message': '请输入您的用户名!',
  'app.settings.basic.name': '用户姓名',
  'app.settings.basic.name-message': '请输入用户姓名',
  'app.settings.basic.userId': '警号（6位数字）',
  'app.settings.basic.userId-message': '请输入警号（6位数字）',
  'app.settings.basic.oldpwd': '旧密码',
  'app.settings.basic.oldpwd-message': '请输入旧密码',
  'app.settings.basic.newpwd': '新密码',
  'app.settings.basic.newpwd-message': '请输入新密码',
  'app.settings.basic.newpwdagain': '再次输入新密码',
  'app.settings.basic.newpwdagain-message': '请再次输入新密码',
  ...
  'app.settings.basic.address': '所属单位',
  'app.settings.basic.address-message': '请输入您的街道地址!',
  'app.settings.basic.phone': '联系电话',
  'app.settings.basic.phone-message': '请输入您的联系电话!',
  'app.settings.basic.update': '更新基本信息',
  'app.settings.basic.updatepwd': '更改密码',
