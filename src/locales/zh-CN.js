export default {
  ...
  'menu.infoconclude.conclude': '足迹比对归纳结果',
  'menu.infoquery': '足迹信息查询',
  'menu.infoquery.basicInfo': '查询页',
  'menu.infoquery.basicResult': '查询结果页',
  ...
  'app.settings.basic.userId': '工号',
  'app.settings.basic.userId-message': '请输入工号',
  ...
  'app.settings.basic.address': '所属机构',
