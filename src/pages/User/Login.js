        ...
        <div className={styles.username}>
          ...
          <Input.Group size="large">
            <div className={styles.inputInfo}>
              ...
              />
              {this.state.hasUser ? (
                <p className={styles.inputAfterText}>please enter username!</p>
              ) : null}
            </div>
            <div className={styles.inputInfo}>
              <Input
              ...
              />
              {this.state.hasPwd ? (
                <p className={styles.inputAfterText}>please enter password!</p>
              ) : null}
            </div>
          </Input.Group>
          <Button onClick={this.onClick} type="primary" className={styles.submitBtn}>
            登录
          </Button>
        </div>
      </div>
